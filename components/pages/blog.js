          ...
          <div className='col-md-4'>
            <div className='right'>
              ...
              <ul className='recent-post'>
                <li>
                  <Link className='recent' href="/blog">
                    <div className='img'>
                      <img
                        src="/img/service.jpg"
                        alt="imgservice"
              ...
              <ul className='tags'>
                <li>
                  <Link className='tag' href="/blog">Interior</Link>
                </li>
                <li>
                  <Link className='tag' href="/blog">Trend</Link>
                </li>
                <li>
                  <Link className='tag' href="/blog">Photography</Link>
                </li>
                <li>
                  <Link className='tag' href="/blog">Design</Link>
                </li>
                <li>
                  <Link className='tag' href="/blog">Exterior</Link>
                </li>
                <li>
                  <Link className='tag' href="/blog">Website</Link>
                </li>
                <li>
                  <Link className='tag' href="/blog">React Js</Link>
                </li>
                <li>
                  <Link className='tag' href="/blog">Creative</Link>
                </li>
              </ul>
