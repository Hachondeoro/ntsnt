          ...
          <div className='col-md-4'>
            <div className='right'>
              <ul className='services-list'>
                ...
                <li>
                  <Link href="/service">Modern Design</Link>
                </li>
                <li>
                  <Link href="/service1">Interior</Link>
                </li>
                <li>
                  <Link className='active' href="/service2">Architecture</Link>
                </li>
                <li>
                  <Link href="/service3">Exterior</Link>
                </li>
              </ul>
