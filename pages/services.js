            ...
            <div className="row">
              ...
              <div className="col-md-6 centered p-5">
                <div className="p-md-5">
                  ...
                  <p className="mt-3">
                    NTS provide specialised partitions and ceiling services.
                    This includes the installation of fire-rated partitions and
              ...
              <div className="col-md-6 centered p-5 pb-5">
                <div className="p-md-5">
                  ...
                  <p className="mt-3">
                    NTS offer a full range of metal building components,
                    including sun-hood screens, window awnings, balustrade and
                    handrails, fences, feature building screens and more.
                  </p>
                </div>
              </div>
              ...
              />
              <div className="col-md-6 pr-md-0">
                <img src="/images/carpentrynew.png" width="100%" alt="#" />
              </div>
              ...
              <div className="col-md-6 centered p-5">
                <div className="p-md-5">
                  ...
                  <p className="mt-3">
                    ...
                    attention to detail and finish in these areas. The services
                    we offer include wardrobes, kitchen cabinets, decorative
                    wall and ceiling panelling, door and hardware, toilet
              ...
              <div className="col-md-6 pl-md-0">
                <img src="/images/demolition.png" width="100%" alt="#" />
              </div>
            </div>
          </div>
        </section>
