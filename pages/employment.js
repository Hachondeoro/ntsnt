        ...
        <div className="row m-10-hor">
          ...
          <div className="col-md-7">
            <div className="content">
              The Northern Trade Solutions (NTS) philosophy “empowering people”
              is at the forefront of our recruitment. We endeavour to work with
              passionate, dedicated and reliable professionals to ensure the
              Territory building and construction industry has access to high
      ...
      <section className="container-fluid employment">
        <div className="row m-10-hor">
          <div className="col-md-3">
            <img src="/images/employment/engineer.png" width="40%" alt="img" />
            <br></br>
            <br></br>
          ...
          <div className="col-md-3">
            <img src="/images/employment/marketing.png" width="40%" alt="img" />
            <br></br>
            <br></br>
            <h2>CONTINUOUS IMPROVEMENT</h2>
            We value self improvement and business progression in everything
            that we do. NTS is proudly driven by a need to continuously improve
            in our services and our involvement in the community. We know that
            the more we improve, the more the Northern Territory building and
          ...
          <div className="col-md-3">
            ...
            workplace and is actively involved in Indigenous communities with a
            vibrant Indigenous employment program.
          </div>
          <div className="col-md-3">
            <img
            ...
            <br></br>
            <h2>TEAM WORK</h2>
            We believe in a satisfied and empowered workforce. NTS is focused on
            the wellbeing and happiness of our employees and put a strong focus
            on team work and a positive work environment for our staff.
          </div>
        </div>
      </section>
      <section className="container-fluid employment">
        <div className="row justify-content-md-center">
          ...
          <div className="col-md-4">
            ...
            <ul>
              <li>A minimum of three years experience in the relevant field</li>
