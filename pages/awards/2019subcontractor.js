      ...
      <section className="col-12 col-md-10 mx-auto d-block text-center awards">
        ...
        <div className="row justify-content-center individual">
          <div className="col-12 col-md-4">
            <img src="/images/awards/Picture9.png" />
          </div>
          <div className="col-12 col-md-4">
            <img src="/images/awards/Picture10.png" />
          </div>
          <div className="col-12 col-md-4">
            <img src="/images/awards/Picture11.png" />
          </div>
          <div className="col-12 col-md-4">
            <img src="/images/awards/Picture12.png" />
          </div>
          <div className="col-12 col-md-4">
            <img src="/images/awards/Picture13.png" />
          </div>
          <div className="col-12 col-md-4">
